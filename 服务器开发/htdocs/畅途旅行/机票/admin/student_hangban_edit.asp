...
sql1="select * from holiday1 where id="&id&""
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
    <td valign="top"> <table border="0" cellpadding="0" cellspacing="0" width="100%" height="26">
        <tr> 
          <td width="100%" height="14"> <form method="POST" name="regfrom" action="student_hangban_edit_ok.asp?page=<%=request("page")%>">
              <div align="center"> 
                <table border="1" cellpadding="0" cellspacing="0" width="70%" bordercolorlight="#0A5092" bordercolordark="#FFFFFF" height="122"><center>
                  <tr> 
                    <td width="100%" bgcolor="#E9EEF8" height="20"> <p align="center">修改航班</td>
                  </tr>
                  <tr> 
                    <td width="100%" height="46" valign="top"> <table border="0" cellpadding="5" cellspacing="1" width="100%" height="393">
                        <tr> 
                        ...
                        <tr> 
                          <td width="24%" bgcolor="#0A5092" align="center" height="13"> 
                            <p align="center" class="style1">大州</td>
                          <td width="76%" height="-2" bgcolor="#E9EEF8"> 
                            <%
...
%>
                        ...
                        <tr> 
                          ...
                          <td width="76%" bgcolor="#E9EEF8" height="27"> 
...
%>
                        ...
                        <tr> 
                          ...
                          <td width="76%" bgcolor="#E9EEF8" height="27"><select size="1" name="plane">
                              <option selected value="<%=rs1("plane")%>"><%=rs1("plane")%></option>
                              <option value="虹桥机场">虹桥机场</option>
                        ...
                        <tr> 
                          ...
                          <td width="76%" bgcolor="#E9EEF8" height="27"><select size="1" name="company">
                              <option selected value="<%=rs1("company")%>"><%=rs1("company")%></option>&nbsp; 
                              <%
                        ...
                        <tr> 
                          ...
                          <td width="76%" bgcolor="#E9EEF8" height="27"><input type="text" name="flycode" size="14" value="<%=rs1("flycode")%>"></td>
                        </tr>
                        <tr> 
                          <td width="24%" bgcolor="#0A5092" align="center" height="27"> 
                            <font color="#FFFFFF">航班机型</font></td>
                          <td width="76%" bgcolor="#E9EEF8" height="27"><input type="text" name="planetype" size="14" value="<%=rs1("planetype")%>"></td>
                        </tr>
                        <tr> 
                          <td width="24%" bgcolor="#0A5092" align="center" height="27"> 
                            <font color="#FFFFFF">每周航班</font></td>
                          <td width="76%" bgcolor="#E9EEF8" height="27"><input type="text" name="flynumber" size="14" value="<%=rs1("flynumber")%>"></td>
                        </tr>
                        <tr> 
                          <td width="24%" bgcolor="#0A5092" align="center" height="27"> 
                            <font color="#FFFFFF">单程价格</font></td>
                          <td width="76%" bgcolor="#E9EEF8" height="27"><input type="text" name="price" size="14" value="<%=rs1("price")%>"></td>
                        </tr>
                        <tr> 
                          <td width="24%" bgcolor="#0A5092" align="center" height="27"> 
                            <font color="#FFFFFF">往返价格</font></td>
                          <td width="76%" bgcolor="#E9EEF8" height="27"><input type="text" name="minprice" size="14" value="<%=rs1("minprice")%>"></td>
                        </tr>
                        <tr> 
                          <td width="24%" bgcolor="#0A5092" align="center" height="27"> 
                            <font color="#FFFFFF">出发时间</font></td>
                          <td width="76%" bgcolor="#E9EEF8" height="27"><input type="text" name="fromtime" size="14" value="<%=rs1("fromtime")%>"></td>
                        </tr>
                        <tr> 
                          <td width="24%" height="-2" align="center" bgcolor="#0A5092"> 
                            <font color="#FFFFFF">到达时间</font></td>
                          <td width="76%" bgcolor="#E9EEF8" height="13"><input type="text" name="totime" size="14" value="<%=rs1("totime")%>"></td>
                        </tr>
                        <tr> 
                          <td height="6" align="center" bgcolor="#0A5092"><span class="style1">备注</span></td>
                          <td height="6" bgcolor="#E9EEF8">&nbsp;</td>
                        </tr>
                        <tr bgcolor="#E9EEF8"> 
                          <td height="6" colspan="2" align="center"><textarea name="content" cols="60" rows="5" id="content"><%=rs1("content")%></textarea></td>
                        </tr>
                        <tr> 
              ...
              <script language="javascript">
	    document.regfrom.from_city.value="<%=trim(rs1("from_city"))%>";
		document.regfrom.areaid.value="<%=trim(rs1("areaid"))%>";
		  changelocation(document.regfrom.areaid.options[document.regfrom.areaid.selectedIndex].value)
	    document.regfrom.countryid.value="<%=trim(rs1("countryid"))%>";
		 changelocationz(document.regfrom.countryid.options[document.regfrom.countryid.selectedIndex].value)
		document.regfrom.cityid.value="<%=trim(rs1("address"))%>";
		</script>
            </form></td>
        </tr>
      </table></td>
