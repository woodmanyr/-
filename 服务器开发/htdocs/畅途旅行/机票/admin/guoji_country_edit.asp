...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td width="85%" valign="top">
      ...
      <form method="POST" name="form1" action="guoji_country_edit_ok.asp?id=<%=id%>">
      <div align="center">
              ...
              <table border="0" cellpadding="5" cellspacing="1" width="100%">
                <tr>
                  <td width="20%" bgcolor="#0A5092" align="center">
                    <p align="center" class="样式1">选择大州：</td>
                ...
                <tr>
                  <td bgcolor="#0A5092" align="center"><font color="#FFFFFF">国　　家：</font></td>
                  <td width="80%" bgcolor="#E9EEF8"><input type="text" name="country" size="42" value="<%=rs("country")%>"></td>
                </tr>
                <tr>
	  ...
	  <script language="javascript">
	    document.form1.areaid.value="<%=trim(rs("areaid"))%>";
		</script>
      </form>
          </td>
        </tr>
