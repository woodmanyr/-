...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#7594E6">
  <tr>
    <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="font">
      <tr>
        <td height="23" bgcolor="#7492EB"><div align="right"><a href="stu_add.asp?action=add">添加信息</a></div></td>
      </tr>
      <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" class="font">
			  <tr bgcolor="#7493E4">
                <td  bgcolor="#94AAEF"  height="25"><div align="center"><strong>特
                      价 信
                          息</strong></div></td>
			  </tr>
			</table>
 ...
 rs.absolutePage=page    
  ...
  for ipage=1 to rs.pagesize  
		  ...
		  %>
            <tr bgcolor="#D6DFF7">
			<td height="24" align="center" bgcolor="#D6DFF7"><a href='../stu_show.asp?id=<%=rs("id")%>' target="_blank"><%=rs("title")%></a></td>
              <td height="24" align="center" bgcolor="#D6DFF7"><div align="center"><a href =stu_add.asp?action=edit&id=<%=rs("id")%>>修 改</a>　　<a href="stu_del.asp?id=<%=rs("id")%>">删 除</a> 　<a href="../stu_show.asp?id=<%=rs("id")%>" target="_blank">查 看</a> 　 </div>                <div align="center"></div>                <div align="center"></div></td>
              </tr>
            <%
		  rs.MoveNext
		  next%>
