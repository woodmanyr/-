              ...
              <table border="1" cellpadding="0" cellspacing="0" width="70%" bordercolorlight="#0A5092" bordercolordark="#FFFFFF" height="122">
                <tr> 
                  <td width="100%" bgcolor="#FFFFFF" height="20"> 
                    <p align="right"><a href="huoche_company_add.asp">添加火车类型&gt;&gt;&gt;</a>
                  </td>
                </tr><center>
                <tr> 
                  <td width="100%" bgcolor="#E9EEF8" height="20"> 
                    <p align="center">火车类型管理
                  </td>
                </tr>
                <tr> 
                  <td width="100%" height="46" valign="top"> <table border="0" cellspacing="1" width="100%">
                      <tr> 
                        <td width="55%" bgcolor="#0A5092"> 
                          <p align="center"><font color="#FFFFFF">火车类型</font></p>
                        </td>
...
for ipage=1 to rs.pagesize  
                %>
                      <tr> 
                        ...
                        <td width="20%"> 
                          <p align="center"><a href="huoche_company_edit.asp?id=<%=rs("id")%>">[修改]</a>&nbsp; 
                            <a href="huoche_company_del.asp?id=<%=rs("id")%>">[删除]</a></p>
                        </td>
                      </tr>
                      <%
                rs.movenext
                ...
                <tr> 
                  <td width="100%" height="26" valign="middle"> 
                    <p align="center"><font color="#333333"><b>共 <font color="#990000"><%=rs.pagecount%> 
                      </font> 页 </b>&nbsp;<font face="webdings"><a href="huoche_company.asp?page=1"><font color="#484848">9</font></a></font> 
                      <font face="webdings"><a href="huoche_company.asp?page=<%=page-1%>"><font color="#484848">7</font></a></font>[ 
                      <%
      for i=1 to rs.pagecount
      if i=page then
      response.write "<font color=""#990000""><b>"&page&"&nbsp;</b></font>"
      else
      response.write "<A HREF=huoche_company.asp?page="&i&">"&"<font color=#000000>"&i&"</font>"&"</A>&nbsp;"
      end if
      next
      
     
            %>
                      ]<font face="webdings"><a href="huoche_company.asp?page=<%=page+1%>"><font color="#484848">8</font></a></font> 
                      <font face="webdings"><a href="huoche_company.asp?page=<%=rs.PageCount%>"><font color="#484848">:</font></a> 
