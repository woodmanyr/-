...
sql = "select * from buy2 where id="&id&""
rs.open sql,conn,3,2

Set rs_ren = Server.CreateObject("ADODB.RecordSet")
sql_ren = "select * from people2 where titleid="&rs("id")&""
              ...
              <tr>
                <td width="50%" valign="top">
                  <table border="0" cellpadding="4" cellspacing="1" width="100%">
                    <tr>
                      <td width="19%" bgcolor="#E9EEF8">姓名</td>
                      <td width="18%"><%=rs("name")%></td>
                      <td width="20%">性别</td>
                      <td width="43%"><%if rs("sex")<>"" then Response.Write(rs("sex"))%></td>
                    </tr>
                    <tr>
                      <td width="19%" bgcolor="#E9EEF8">手机号码</td>
                      <td colspan="3"><%=rs("people_number")%></td>
                    </tr>
                    <tr>
                      <td width="19%" bgcolor="#E9EEF8">联系电话</td>
                      <td colspan="3"><%=rs("phone")%></td>
                    </tr>
                    <tr>
                      <td width="19%" bgcolor="#E9EEF8">联系地址</td>
                      <td colspan="3"><%=rs("address")%></td>
                    </tr>
                    <tr>
                      <td width="19%" bgcolor="#E9EEF8">E-mail</td>
                      <td colspan="3"><%=rs("email")%></td>
                    </tr>
                    <tr>
                      <td width="19%" bgcolor="#E9EEF8">QQ</td>
                      <td colspan="3"><%=rs("qq")%></td>
                    </tr>
                    <tr>
                      <td width="19%" bgcolor="#E9EEF8">乘机时间</td>
                      <td colspan="3"><%=rs("goTime")%></td>
                    </tr>
                    <tr>
                      <td width="19%" bgcolor="#E9EEF8">返回时间</td>
                      <td colspan="3"><%=rs("backTime")%></td>
                    </tr>
                    <tr>
                      <td width="19%" bgcolor="#E9EEF8">备注</td>
                      <td colspan="3"><%=rs("more")%></td>
                    </tr>
                    <tr>
                      <td width="19%" bgcolor="#E9EEF8">购买数量</td>
...
<%next%>
        ...
        <tr>
            ...
            <p align="center"><a href="student_dinggou.asp">返回&gt;&gt;&gt;</a>
            </td>
        </tr>
        </table>
        </center>
