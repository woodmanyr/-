...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
    <td valign="top"> <table border="0" cellpadding="0" cellspacing="0" width="100%" height="26">
        <tr> 
          <td width="100%" height="14"> <form method="POST" action="news_edit_ok.asp">
              <div align="center"> 
                <table border="1" cellpadding="0" cellspacing="0" width="70%" bordercolorlight="#0A5092" bordercolordark="#FFFFFF" height="122"><center>
                  <tr> 
                    <td width="100%" bgcolor="#E9EEF8" height="20"> <p align="center">修改最新信息</td>
                  </tr>
                  <tr> 
                    <td width="100%" height="46" valign="top"> <table border="0" cellpadding="5" cellspacing="1" width="100%">
                       <tr> 
                          <td width="20%" bgcolor="#0A5092" align="center"> <p align="center"><font color="#FFFFFF">栏目</font></td>
                          <td width="80%" bgcolor="#E9EEF8"><select name="sort" id="sort">
                            <option value="1" selected>国内机票</option>
                            <option value="2">国际机票</option>
                            <option value="3">其它</option>
                          </select></td>
<script>document.all.sort.value='<%=rs("sort")%>'</script>
                        </tr> <tr> 
