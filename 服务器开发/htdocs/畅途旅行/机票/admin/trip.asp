...
case else 
            artype=""
End select
strSel="select * from Trip where type like '%"&artype&"'"
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#7594E6">
  <tr>
    <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="font">
      <tr>
        <td height="23" bgcolor="#7492EB"><div align="right"><a href="Trip_add.asp?action=add">添加信息</a></div></td>
      </tr>
      <tr>
        <td height="22" bgcolor="#D6DFF7"><div align="center"><a href="?type_id=0">广告行程</a>　　　　<a href="?type_id=1">常规行程</a>　　　　<a href="?type_id=2">自由行</a> 　　<a href="?type_id=3">华东行程</a></div></td>
      </tr>
      <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" class="font">
			  <tr bgcolor="#7493E4">
                <td  bgcolor="#94AAEF"  height="25"><div align="center"><strong>公 司 信 息</strong></div></td>
			  </tr>
			</table>
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" class="font">
            <tr bgcolor="#7493E4">
              <td width="172" height="23" bgcolor="#94AAEF"><div align="center"></div>                
                <div align="center">所属分类</div>                </td>
              <td width="549" height="23" bgcolor="#94AAEF"><div align="center"></div>
                <div align="center">信息标题</div></td>
              <td width="214" bgcolor="#94AAEF"><div align="center"></div>                <div align="center">操作</div></td>
              <td width="67" bgcolor="#94AAEF"><div align="center">批量处理</div></td>
            </tr>
            <%	
			page=Request("page") 
	if page="" then
 ...
 rs.absolutePage=page    
  ...
  for ipage=1 to rs.pagesize  
		  ...
		  %>
			...
			<%=rs("type")%></td>
              <td align="center"><a href='../Trip_show.asp?id=<%=rs("id")%>' target="_blank"><%=rs("title")%></a></td>
              <td height="24" align="center"><div align="center"><a href =Trip_add.asp?action=edit&id=<%=rs("id")%>>修 改</a>　　<a href=?action=del&id=<%=rs("id")%>>删 除</a> 　<a href="../Trip_show.asp?id=<%=rs("id")%>" target="_blank">查 看</a> 　 </div>                <div align="center"></div></td>
              <td height="24" align="center"><div align="center">
                <input type="checkbox" name="checkbox1" value="<%=rs("id")%>">
              </div></td>
            </tr>
            <%
		  rs.MoveNext
		  next%>
		  <tr bgcolor="#94AAEF">
		  <td height="22" colspan="4"  bgcolor="#94AAEF"><div align="right">反选
