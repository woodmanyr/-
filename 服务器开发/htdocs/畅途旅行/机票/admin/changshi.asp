...
if Request.Form("submit2")="批量删除" then
  ...
  strSel="delete  from student  where id="&Request.Form("checkbox1")(i)
  conn.Execute(strSel)
 next
...
if Request.QueryString("action")="del" then
  ...
  strSel="delete * from student where id="&id
  conn.Execute (strSel)
  Response.Redirect("changshi.asp")
end if


strSel="select * from server"
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#7594E6">
  <tr>
    <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="font">
      <tr>
        <td height="23" bgcolor="#7492EB"><div align="right"><a href="changshi_add.asp?action=add">添加信息</a></div></td>
      </tr>
      <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" class="font">
			  <tr bgcolor="#7493E4">
                <td  bgcolor="#94AAEF"  height="25"><div align="center"><strong>机
                      票 常 识</strong></div></td>
			  </tr>
			</table>
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" class="font">
            <tr bgcolor="#7493E4">
              <td width="71%" height="23" bgcolor="#94AAEF"><div align="center"></div>                <div align="center">信息标题</div></td>
              <td width="29%" bgcolor="#94AAEF"><div align="center"></div>                <div align="center">操作</div>                <div align="center"></div></td>
              </tr>
            <%	
			page=Request("page") 
	if page="" then
 ...
 rs.absolutePage=page    
  ...
  for ipage=1 to rs.pagesize  
		  ...
		  %>
            <tr bgcolor="#D6DFF7">
			<td height="24" align="center" bgcolor="#D6DFF7"><a href='../changshi_show.asp?id=<%=rs("id")%>' target="_blank"><%=rs("title")%></a></td>
              <td height="24" align="center" bgcolor="#D6DFF7"><div align="center"><a href =changshi_add.asp?action=edit&id=<%=rs("id")%>>修 改</a>　　<a href="changshi_del.asp?id=<%=rs("id")%>">删 除</a> 　<a href="../changshi_show.asp?id=<%=rs("id")%>" target="_blank">查 看</a> 　 </div>                <div align="center"></div>                <div align="center"></div></td>
              </tr>
            <%
		  rs.MoveNext
		  next%>
		  <tr bgcolor="#94AAEF">
		  <td height="22" colspan="2"  bgcolor="#94AAEF"><div align="right"></div></td>
		  </tr>
        </table>
        </form></td>
      </tr>
