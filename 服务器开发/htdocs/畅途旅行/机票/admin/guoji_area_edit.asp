...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td width="85%" valign="top">
      ...
      <form method="POST" action="guoji_area_edit_ok.asp">
      <div align="center">
              ...
              <table border="0" cellpadding="5" cellspacing="1" width="100%">
                <tr>
                  <td width="20%" bgcolor="#0A5092" align="center">
                    <p align="center"><font color="#FFFFFF">目的地</font></td>
                  <td width="80%" bgcolor="#E9EEF8"><input name="area" type="text" id="area" value="<%=rs(1)%>" size="42"></td>
                </tr>
                <tr>
