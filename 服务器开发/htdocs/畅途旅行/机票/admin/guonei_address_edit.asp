...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
    <td valign="top"> <table border="0" cellpadding="0" cellspacing="0" width="100%" height="26">
        <tr> 
          <td width="100%" height="14"> <form method="POST" action="guonei_address_edit_ok.asp">
              <div align="center"> 
                  ...
                  <tr> 
                    <td width="100%" height="46" valign="top"> <table border="0" cellpadding="5" cellspacing="1" width="100%">
                        <tr> 
                          ...
                          <td width="80%" bgcolor="#E9EEF8"><input type="text" name="address" size="42" value="<%=rs("address")%>"></td>
                        </tr>
                        <tr> 
