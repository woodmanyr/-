        ...
        <tr> 
          <td width="100%" height="14"> <div align="center"> 
              <table border="1" cellpadding="0" cellspacing="0" width="70%" bordercolorlight="#0A5092" bordercolordark="#FFFFFF" height="122">
                <tr> 
                  <td width="100%" bgcolor="#FFFFFF" height="20"> <p align="right"><a href="gg_add.asp">添加公告&gt;&gt;&gt;</a></td>
                </tr><center>
                <tr> 
                  <td width="100%" bgcolor="#E9EEF8" height="20"> <p align="center">网站公告管理</td>
                </tr>
                <tr> 
...
if rs.Eof then exit for 
                %>
                      <tr> 
                        <td width="55%"> <p align="center"><%=rs("title")%></td>
                        <td width="25%"> <p align="center"><%=rs("date")%></td>
                        <td width="20%"> <p align="center"><a href="gg_edit.asp?id=<%=rs("id")%>">[修改]</a>&nbsp; 
                            <a href="gg_del.asp?id=<%=rs("id")%>">[删除]</a></p></td>
                      </tr>
                      <%
                rs.movenext
                If rs.eof then exit for
                ...
                <tr> 
                  <td width="100%" height="26" valign="middle"> <p align="center"><font color="#333333"><b>共 
                      <font color="#990000"><%=rs.pagecount%> </font> 页 </b>&nbsp;<font face="webdings"><a href="gg.asp?page=1"><font color="#484848">9</font></a></font> 
                      <font face="webdings"><a href="gg.asp?page=<%=page-1%>"><font color="#484848">7</font></a></font>[ 
                      <%
      for i=1 to rs.pagecount
      if i=page then
      response.write "<font color=""#990000""><b>"&page&"&nbsp;</b></font>"
      else
      response.write "<A HREF=gg.asp?page="&i&">"&"<font color=#000000>"&i&"</font>"&"</A>&nbsp;"
      end if
      next
      
     
            %>
                      ]<font face="webdings"><a href="gg.asp?page=<%=page+1%>"><font color="#484848">8</font></a></font> 
                      <font face="webdings"><a href="gg.asp?page=<%=rs.PageCount%>"><font color="#484848">:</font></a> 
