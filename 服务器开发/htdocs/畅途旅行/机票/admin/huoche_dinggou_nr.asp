...
sql_ren = "select * from people3 where titleid="&rs("id")&""
            ...
            <td width="100%" valign="top">
                    <table border="1" cellpadding="0" cellspacing="0" width="100%" height="52" bordercolorlight="#0A5092" bordercolordark="#FFFFFF">
                      <tr> 
                        ...
                        <td width="9%" align="center" height="18" bgcolor="#000080"><font color="#FFFFFF">车次类型</font></td>
                        ...
                        <td width="9%" align="center" height="18" bgcolor="#000080"><font color="#FFFFFF">车次</font></td>
                        <td width="6%" align="center" height="18" bgcolor="#000080"><font color="#FFFFFF">硬座</font></td>
...
rs1.open sql1,conn,3,2
                ...
                %>
                      <tr> 
                        ...
                        <td width="9%" height="18" align="center"><%=rs1("flycode")%></td>
                        <td width="6%" height="18" align="center"><%=rs1("planetype")%></td>
                ...
                <td width="50%" valign="top">
                          <table border="0" cellpadding="4" cellspacing="1" width="100%">
                            <tr> 
                              ...
                              <td width="20%">性别</td>
                              <td width="43%"> 
                                <%if rs("sex")<>"" then Response.Write(rs("sex"))%>
                              </td>
                            </tr>
                            <tr> 
...
<%next%>
        ...
        <tr>
            ...
            <p align="center"><a href="huoche_dinggou.asp">返回&gt;&gt;&gt;</a>
            </td>
        </tr>
        </table>
            </div>
