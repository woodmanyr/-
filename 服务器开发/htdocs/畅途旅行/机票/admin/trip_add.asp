...
if (document.myform.class_id.value=="-1"){
     alert("请选择分类!");
     return false;
	}
        ...
        <tr bgcolor="#D6DFF7">
          <td height="22" colspan="2"><div align="right">
              <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="19%" height="22"><div align="right">所属栏目：</div></td>
                  <td width="81%" height="11"><div align="left">
				  
                    <select name="class_id"   class="input" id="class_id">
                      <option value="-1" selected>选择所属栏目</option>
                      <option value="广告行程">广告行程</option>
                      <option value="常规行程">常规行程</option>
                      <option value="自由行">自由行</option>
                      <option value="华东行程">华东行程</option>
                        </select>
</div></td>
                </tr>
                ...
                <tr>
                  <td height="22"><div align="right">推荐：</div></td>
                  <td height="11"><div align="left">
...
<script language="javascript">
<% if Request.QueryString("action")="edit" then%>
  document.myform.class_id.value="<%=rs("type")%>";
