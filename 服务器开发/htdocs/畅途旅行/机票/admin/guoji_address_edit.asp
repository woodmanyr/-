...
sql = "select * from address1 where id="&id&""
rs_address.open sql,conn,3,2
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
    <td valign="top"> <table border="0" cellpadding="0" cellspacing="0" width="100%" height="26">
        <tr> 
          <td width="100%" height="14"> <form method="POST" name="form1" action="guoji_address_edit_ok.asp?id=<%=id%>&page=<%=Request("page")%>">
              <div align="center"> 
                <table border="1" cellpadding="0" cellspacing="0" width="70%" bordercolorlight="#0A5092" bordercolordark="#FFFFFF" height="122"><center>
                  <tr> 
                    <td width="100%" bgcolor="#E9EEF8" height="20" > <p align="center">修改目的地</td>
                  </tr>
                  <tr> 
                    <td width="100%" height="46" valign="top"> <table border="0" cellpadding="5" cellspacing="1" width="100%">
                        <tr> 
                          <td width="20%" bgcolor="#0A5092" align="center" > 
                            <p align="center" class="样式1 style1">选择所所地：</td>
...
%>
                        ...
                        <tr> 
                          <td width="20%" bgcolor="#0A5092" align="center"> <p align="center"><font color="#FFFFFF">目的地</font></td>
                          <td width="80%" bgcolor="#E9EEF8"><input type="text" name="address" size="42" value="<%=rs_address("address")%>"></td>
                        </tr>
                        <tr> 
              ...
              <script language="javascript">
	    <% Set rs_country1 = Server.CreateObject("ADODB.RecordSet")
        sql = "select * from country where countryid=" & rs_address("countryid")
        rs_country1.open sql,conn,3,2%>
		document.form1.areaid.value="<%=trim(rs_country1("areaid"))%>";
		 changelocation(document.form1.areaid.options[document.form1.areaid.selectedIndex].value)
	    document.form1.countryid.value="<%=trim(rs_address("countryid"))%>";
		</script>
            </form></td>
        </tr>
      </table></td>
