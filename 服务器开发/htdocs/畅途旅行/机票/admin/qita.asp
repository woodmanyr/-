...
if Request.Form("submit2")="批量删除" then
  ...
  strSel="delete  from qita  where id="&Request.Form("checkbox1")(i)
  conn.Execute(strSel)
 next
...
if Request.QueryString("action")="del" then
  ...
  strSel="delete * from qita where id="&id
  conn.Execute (strSel)
  Response.Redirect("Trip.asp")
end if


strSel="select * from qita"
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#7594E6">
  <tr>
    <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="font">
      <tr>
        <td height="23" bgcolor="#7492EB">
            <div align="right"><a href="qita_add.asp?action=add">添加信息</a></div>
          </td>
      </tr>
      <tr>
 ...
 rs.absolutePage=page    
  ...
  for ipage=1 to rs.pagesize  
		  ...
		  %>
            <tr bgcolor="#D6DFF7">
			<td height="24" align="center" bgcolor="#D6DFF7"><a href='../qita_show.asp?id=<%=rs("id")%>' target="_blank"><%=rs("title")%></a></td>
              <td height="24" align="center" bgcolor="#D6DFF7">
                    <div align="center"><a href =qita_add.asp?action=edit&id=<%=rs("id")%>>修 
                      改</a>　　<a href="qita_del.asp?id=<%=rs("id")%>">删 除</a> 　<a href="../qita_show.asp?id=<%=rs("id")%>" target="_blank">查 
                      看</a> 　 </div>                
