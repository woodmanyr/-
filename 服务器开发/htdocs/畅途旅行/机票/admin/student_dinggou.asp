...
sql1 = "select * from holiday1 where id="&rs("titleid")&""
rs1.open sql1,conn,3,2
                ...
                <tr>
                  ...
                  <td width="13%" height="18" align="center"><a href="student_dinggou_nr.asp?id=<%=rs("id")%>"><font color="#000000">[详细情况]</font></a><font color="#000000">&nbsp;   
                    </font><a href="guoji_dinggou_del.asp?id=<%=rs("id")%>"><font color="#000000">[删除]</font></a></td>
                </tr>
                <%
                rs.movenext
          ...
          <tr>
            ...
            </font> 页 </b>&nbsp;<font face="webdings"><a href="guoji_dinggou.asp?page=1"><font color="#484848">9</font></a></font>        
            <font face="webdings"><a href="guoji_dinggou.asp?page=<%=page-1%>"><font color="#484848">7</font></a></font>[        
            <%
      for i=1 to rs.pagecount
      if i=page then
      response.write "<font color=""#990000""><b>"&page&"&nbsp;</b></font>"
      else
      response.write "<A HREF=guoji_dinggou.asp?page="&i&">"&"<font color=#000000>"&i&"</font>"&"</A>&nbsp;"
      end if
      next
      
     
            %>
            ]<font face="webdings"><a href="guoji_dinggou.asp?page=<%=page+1%>"><font color="#484848">8</font></a></font>        
            <font face="webdings"><a href="guoji_dinggou.asp?page=<%=rs.PageCount%>"><font color="#484848">:</font></a>        
