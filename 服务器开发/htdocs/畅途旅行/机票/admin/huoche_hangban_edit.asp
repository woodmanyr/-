...
sql1="select * from holiday3 where id="&id&""
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr> 
    <td valign="top"> <table border="0" cellpadding="0" cellspacing="0" width="100%" height="26">
        <tr> 
          <td width="100%" height="14"> <form method="POST" action="huoche_hangban_edit_ok.asp">
              <div align="center"> 
                  ...
                  <tr> 
                    <td width="100%" height="46" valign="top"> 
                      <table border="0" cellpadding="5" cellspacing="1" width="100%" height="336">
                        <tr> 
                          ...
                          <td width="80%" bgcolor="#E9EEF8" height="27"> 
                            <select size="1" name="address">
                              <option value="<%=rs1("address")%>" selected><%=rs1("address")%></option>&nbsp; 
                              <%
                        rs.movefirst
                        ...
                        <tr> 
                          <td width="20%" bgcolor="#0A5092" align="center" height="27"> 
                            <font color="#FFFFFF">车次类型</font></td>
                          <td width="80%" bgcolor="#E9EEF8" height="27"> 
                        ...
                        <tr> 
                          ...
                          <td width="80%" bgcolor="#E9EEF8" height="27"> 
                            <input type="text" name="flycode" size="14" value="<%=rs1("flycode")%>">
                          </td>
                        </tr>
                        <tr> 
                          <td width="20%" bgcolor="#0A5092" align="center" height="27"> 
                            <font color="#FFFFFF">硬座价格</font></td>
                          <td width="80%" bgcolor="#E9EEF8" height="27"> 
                            <input type="text" name="planetype" size="14" value="<%=rs1("planetype")%>">
                          </td>
                        </tr>
                        <tr> 
                          <td width="20%" bgcolor="#0A5092" align="center" height="27"><font color="#FFFFFF">软座价格</font></td>
                          <td width="80%" bgcolor="#E9EEF8" height="27">
                            <input type="text" name="planetype1" size="14" value="<%=rs1("planetype1")%>">
                          </td>
                        </tr>
                        <tr> 
                          <td width="20%" bgcolor="#0A5092" align="center" height="27"> 
                          ...
                          <td width="80%" bgcolor="#E9EEF8" height="27"> 
                            <input type="text" name="flynumber" size="14" value="<%=rs1("flynumber")%>">
                          </td>
                        </tr>
                        <tr> 
                          <td width="20%" bgcolor="#0A5092" align="center" height="27"> 
                          ...
                          <td width="80%" bgcolor="#E9EEF8" height="27"> 
                            <input type="text" name="price" size="14" value="<%=rs1("price")%>">
                          </td>
                        </tr>
                        <tr> 
                          <td width="20%" bgcolor="#0A5092" align="center" height="27"> 
                          ...
                          <td width="80%" bgcolor="#E9EEF8" height="27"> 
                            <input type="text" name="minprice" size="14" value="<%=rs1("minprice")%>">
                          </td>
                        </tr>
                        <tr> 
                          <td width="20%" bgcolor="#0A5092" align="center" height="27"><font color="#FFFFFF">软卧下铺</font></td>
                          <td width="80%" bgcolor="#E9EEF8" height="27"> 
                            <input type="text" name="flynumber1" size="14" value="<%=rs1("flynumber1")%>">
                          </td>
                        </tr>
                        <tr> 
                          <td width="20%" bgcolor="#0A5092" align="center" height="27"> 
                          ...
                          <td width="80%" bgcolor="#E9EEF8" height="27"> 
                            <input type="text" name="fromtime" size="14" value="<%=rs1("fromtime")%>">
                          </td>
                        </tr>
                        <tr> 
                          <td width="20%" bgcolor="#0A5092" align="center" height="27"> 
                          ...
                          <td width="80%" bgcolor="#E9EEF8" height="27"> 
                            <input type="text" name="totime" size="14" value="<%=rs1("totime")%>">
                          </td>
                        </tr>
                        <tr> 
