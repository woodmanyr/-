...
<div align="center">
  ...
  <table border="0" cellpadding="0" cellspacing="0" width="500">
      ...
      <td width="100%">
        ...
        <table width="500" height="57" border="1" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#CA9800" bordercolordark="#FFFFFF">
          <tr bgcolor="#ECB100"> 
            ...
            <td width="16%" height="31" align="center" bgcolor="#ECB100"><strong><font color="#FFFFFF">车次种类</font></strong></td>
    ...
    <tr>
      ...
      <form method="POST"  action="huoche_buy_people.asp" name="regform">
        <div align="center">
            <table border="1" cellspacing="0" width="500" bordercolorlight="#CA9800" bordercolordark="#FFFFFF" cellpadding="5">
              ...
              <tr> 
                ...
                <td>
                  <select size="1" name="leixing">
                    <option value="请选择座位类型" selected>请选择座位类型</option>
                    <option value="硬座">硬座</option>
                    <option value="软座">软座</option>
                    <option value="硬卧上铺">硬卧上铺</option>
                    <option value="硬卧下铺">硬卧下铺</option>
                    <option value="软卧上铺">软卧上铺</option>
                    <option value="软卧下铺">软卧下铺</option>
                  </select>
                </td>
              </tr>
              <tr bgcolor="#FFF5D7"> 
              ...
              <tr bgcolor="#FFF5D7"> 
                <td colspan="4"> 
                  <p align="center"><a href="javascript:validate()"><font color="#000000">[下一步]</font></a></p>
                </td>
              </tr>
            </table>
        </div>
