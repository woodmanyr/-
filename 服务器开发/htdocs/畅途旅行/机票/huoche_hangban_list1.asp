            ...
            <td width="74%" height="11"> 
              <table border="1" cellpadding="0" cellspacing="0" width="774"  bordercolorlight="#B3C6D9" bordercolordark="#FFFFFF">
                <tr> 
                  ...
                  <td width="74" align="center" bgcolor="#7B9EC6"><font color="#FFFFFF">软座</font></td>
...
for ipage=1 to rs_search.pagesize  
                ...
                <tr onMouseMove="roll(this,'in','#D9F2FF');" 
                  ...
                  <td width="74" align="center"><%=rs_search("planetype1")%></td>
                  ...
                  <td width="79" align="center"><a href="#" onClick=javascript:window.open('huoche_buy.asp?id=<%=rs_search("id")%>','','500,400,scrollbars=yes,resizable=yes')><font color="#000000"> 
