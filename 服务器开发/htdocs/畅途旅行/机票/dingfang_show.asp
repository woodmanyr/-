...
strSel="select * from dingfang where id="&id
...
%>
      ...
      align=center border=0>
        ...
        <tr> 
          <td align=middle height=19><span id=lblType>作者： </span><span class="style15">上海航空商务旅行网</span> 
