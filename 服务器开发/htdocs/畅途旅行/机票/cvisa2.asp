      ...
      <table cellspacing=0 cellpadding=0 width=778 align=center border=0>
        ...
        <tr valign=top> 
          <td> 
            ...
            src="images/flowtitle.gif" width=607></td>
              </tr>
              <tr> 
                <td> 
                  <table cellspacing=0 cellpadding=0 width="100%" border=0>
                  ...
                  border=0>
                        ...
                        <span 
                  class=a105>港、澳、台、华侨、外籍人在沪就业、居留办证基本流程图<br>
                        <br>
                        </span> 
                  ...
                  bgcolor=#000000 border=0>
                          ...
                          <tr bgcolor=#efefef> 
                            <td> 
                              <div align=center> 
                                <p style="MARGIN: 4px">外籍人 </p>
                              </div>
                            </td>
                            <td> 
                              <div align=center>港、澳、华侨</div>
                            </td>
                            <td> 
                              <div align=center>中国台湾</div>
                            </td>
                          </tr>
                          <tr bgcolor=#ffffff> 
                            <td> 
                              <div align=center> 
                                <p style="MARGIN: 4px"><img height=18 
                        src="images/zhizheng.gif" width=9></p>
                              </div>
                            </td>
                            <td> 
                              <div align=center><img height=18 
                        src="images/zhizheng.gif" width=9></div>
                            </td>
                            <td> 
                              <div align=center><img height=18 
                        src="images/zhizheng.gif" width=9></div>
                          ...
                          <tr bgcolor=#efefef> 
                            <td> 
                              <div align=center> 
                                <p style="MARGIN: 4px">就业许可证（可省略） </p>
                              </div>
                            </td>
                            <td> 
                              <div align=center>临时住宿登记表</div>
                            </td>
                            <td> 
                              <div align=center>临时住宿登记表</div>
                            </td>
                        ...
                        src="images/zhizheng.gif" width=9></div>
                          ...
                          <tr bgcolor=#efefef> 
                            <td> 
                              <div align=center> 
                                <p style="MARGIN: 4px">签证通知书（可省略） </p>
                              </div>
                            </td>
                            <td> 
                              <div align=center>体检</div>
                            </td>
                            <td> 
                              <div align=center>体检</div>
                            </td>
                        ...
                        src="images/zhizheng.gif" width=9></div>
                          ...
                          <tr bgcolor=#efefef> 
                            <td> 
                              <div align=center> 
                                <p style="MARGIN: 4px">临时住宿登记表</p>
                              </div>
                            </td>
                            <td> 
                              <div align=center>就业证</div>
                            </td>
                            <td> 
                              <div align=center>就业证</div>
                            </td>
                        ...
                        src="images/zhizheng.gif" width=9></div>
                          ...
                          <tr bgcolor=#efefef> 
                            <td> 
                              <div align=center> 
                                <p style="MARGIN: 4px">体检</p>
                              </div>
                            </td>
                            <td> 
                              <div align=center>暂住证</div>
                            </td>
                            <td> 
                              <div align=center>签注签注</div>
                            </td>
                          </tr>
                          <tr bgcolor=#ffffff> 
                            <td> 
                        ...
                        src="images/zhizheng.gif" width=9></p>
                          ...
                          <tr bgcolor=#efefef> 
                            <td> 
                              <div align=center> 
                                <p style="MARGIN: 4px">工作签证＋居留许可 </p>
                              </div>
                            </td>
                            <td> 
                              <div align=center></div>
                  ...
                  align=center></div>
                        ...
                        <br>
                        如果您正是一位人事部负责人且正为这些琐事伤神，现在就联系我们吧！低廉的费用及高效的服务，将会让你感到物有所值。或者您有外国友人来华旅游，需要申请商务签证或签证延期、加签，及任何签证相关事宜都可以来电或发Email咨询！我们随时待命，为您服务！ 
                        <br>
                        <br>
                        <br>
                        <br>
