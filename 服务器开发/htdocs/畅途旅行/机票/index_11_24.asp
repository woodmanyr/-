...
<HTML>
<HEAD>
<TITLE>飞机票,<%=site_name%></TITLE>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<meta name="description" content="飞机票,中国,上海,上海东航南航上航联合售票处,上海东航南航上航联合售票处票务中心,上海航空商务旅行网, 国内机票, 国际机票, 特价机票,打折机票,上海飞机票,飞机票, 火车票, 酒店预定, 旅游咨询, 商务签证, 航班查询, 预定服务">
<meta name="keywords" content="飞机票,中国,上海,上海东航南航上航联合售票处,上海东航南航上航联合售票处票务中心,上海航空商务旅行网, 国内机票, 国际机票, 特价机票,打折机票,上海飞机票,飞机票, 火车票, 酒店预定, 旅游咨询, 商务签证, 航班查询, 预定服务">
...
<script src="http://www.webqy.cn/tongji/mystat.asp?siteid=2"></script>
<script>
...
align=center>
      ...
      <table cellspacing=1 cellpadding=1 width=200 bgcolor=#dfdfdf border=0>
        <tbody> 
        <tr> 
          <td bgcolor=#f4f4f4> 
            <table cellspacing=0 cellpadding=0 width="100%" border=0>
              ...
              <tr> 
                <td align=middle height=30><font 
                color=#666666><b><span id="lb_ViewBoard"><span class="mainzi">MSN联系方式</span></span></b></font></td>
              </tr>
              </tbody> 
            </table>
            <table cellspacing=1 cellpadding=2 width="100%" bgcolor=#dfdfdf 
            border=0>
              ...
              <tr> 
                <td valign=top bgcolor=#ffffff> 
                  <table  border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
                    <tr> 
                      <td class="textbody" background="images/index_msn.png">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td height="25"><span id="lb_ViewBoard">ZELV888_PC1@HOTMAIL.COM</span></td>
                          </tr>
                          <tr> 
                            <td height="25"><span id="lb_ViewBoard">ZELV888_PC2@HOTMAIL.COM</span></td>
                          </tr>
                          <tr> 
                            <td height="25"><span id="lb_ViewBoard">ZELV888_PC3@HOTMAIL.COM</span></td>
                          </tr>
                          <tr> 
                            <td height="25"><span id="lb_ViewBoard">ZELV888_PC4@HOTMAIL.COM</span></td>
                          </tr>
                          <tr> 
                            <td height="30">在线客服:</td>
                          </tr>
                          <tr> 
                            <td height="25">ZHUANGLIAN@MSN.COM </td>
                          </tr>
                        </table>
                        <br>
                      </td>
...
rs.Open sql,conn,3,2%>
        ...
        <tr> 
          ...
          <td> 
            <table border="0" cellpadding="1" cellspacing="1" width="98%" align="center" bordercolor="#C0C2C2" class="textbody">
              ...
              <%
             sql="select top 18 id,address,company,flycode,price,minprice from holiday where flag=1 order by id desc "
             rs.Open sql,conn,3,2
			for i=1 to rs.recordcount
			if rs.Eof then exit for
			%>
              <tr <%if i mod 2=1 then %> bgcolor="#F2F1EE" <%end if%> onMouseMove="roll(this,'in','#D9F2FF');" 
                ...
                <td height="25" width="19%"><%=rs("company")%> 
                  <div align="left"></div>
                </td>
                <td height="25" width="18%"><%=rs("flycode")%> 
                  <div align="left"></div>
				</td>
      ...
      <table cellspacing=0 cellpadding=5 width="578" border=0>
        ...
        <tr align=middle> 
          <td width="33%"><a 
            href="guonei_hangban_list1.asp"><img 
          ...
          <td width="33%"><a 
            ...
            border=0></a></td>
          <td width="33%"><a 
            href="guoji_hangban_list1.asp"><img 
        ...
        <tr> 
          <td> 
            ...
            <table cellspacing=0 cellpadding=0 width=190 border=0>
              ...
              <tr> 
                ...
                <td valign=top align=left> 
                  ...
                  width=52 align=right><span 
                  class=style3><a href="cvisa5.asp" target="_blank">当您需要去国外参加商务活动或者前往自助游时，办理签证是否一件很麻烦的事情？需要咨询多种信息、填写众多表格。咨询我们，将会为您提供协办多国签证的服务。</a> 
                    </span></p>
                </td>
              </tr>
              </tbody>
            ...
            <table cellspacing=0 cellpadding=0 width=200 border=0>
              <tbody> 
              <tr> 
                <td align=right><a href="cvisa5.asp" 
...
border=0>
                          ...
                          <tr> 
                            ...
                            <td width="209"><img height=46 
                              ...
                              align=left><span 
                              class=style3><a href="cvisa6.asp" target="_blank">请自行至吴淞路333号上海市出入境管理局递交相关材料， 
