...
for ipage=1 to rs.pagesize  
              ...
              <tr> 
                <td width="11%" height="25" align="center"> 
                  <div align="left">　　· <a href=dingfang_show.asp?id=<%=rs("id")%> target="_blank"><%=rs("title")%></a><br>
                  </div>
                </td>
              </tr>
              <%
              ...
              <tr> 
                <td height="18" align="center" colspan="11"> 
                  <p align="center"><font color="#333333" size="2"><b>共 <font color="#990000"><%=rs.pagecount%></font> 
                    页 </b>&nbsp;<font face="webdings"><a href="dingfang.asp?page=1"><font color="#484848">9</font></a></font> 
                    <font face="webdings"> <a href="dingfang.asp?page=<%=page-1%>"> 
      ...
      response.write "<A HREF=dingfang.asp?page="&i&">"&"<font color=#000000>"&i&"</font>"&"</A>&nbsp;"
      end if
     next
      
     
      %>
                    ]<font face="webdings"><a href="dingfang.asp?page=<%=page+1%>"><font color="#484848">8</font></a></font> 
                    <font face="webdings"> <a href="dingfang.asp?page=<%=rs.PageCount%>"> 
