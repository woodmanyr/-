...
align=center>
                  ...
                  <table  border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
                    <tr> 
                      <td class="textbody" background="images/index_msn.png">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr> 
                            <td height="25"><span id="lb_ViewBoard"></span></td>
                          </tr>
                          <tr> 
                            <td height="25">&nbsp;</td>
                          </tr>
        ...
        <tr> 
          <td bgcolor=#f4f4f4> 
            <table cellspacing=0 cellpadding=0 width="100%" border=0>
              ...
              <tr> 
                <td align=middle height=30><font 
                color=#666666><b><span id="lb_ViewBoard"><span class="mainzi">QQ联系方式</span></span></b></font></td>
              </tr>
              </tbody> 
            </table>
            <table cellspacing=1 cellpadding=2 width="100%" bgcolor=#dfdfdf 
    ...
    <td valign=top align=middle width="578"> 
      ...
      scrolldelay=2 width="100%">&nbsp;&nbsp;&nbsp; <font size=2><b>我们的工作时间 8:30--22:30 
          ...
          <td> 
			...
			%>
              <tr <%if i mod 2=1 then %> bgcolor="#F2F1EE" <%end if%> onMouseMove="roll(this,'in','#D9F2FF');" 
                ...
                <td height="25" width="16%"> <%=rs("address")%> 
                  <div align="left"></div>
                </td>
                <td height="25" width="18%"><%=rs("company")%> 
                  <div align="left"></div>
                </td>
