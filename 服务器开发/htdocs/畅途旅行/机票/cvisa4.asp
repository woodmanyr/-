              ...
              <tr> 
                <td> 
                  ...
                  border=0>
                        ...
                        <span 
                  class=a105>台胞证1年多次或2年多次签注加注服务<br>
                        <br>
                        </span>台胞来往大陆通行证签注所需材料：<br>
                        <br>
                        1、身份证复印件1份（清晰）<br>
                        2、照片2张彩照（小两寸）<br>
                        3、本人必须在境内<br>
                        4、台胞来往大陆通行证原件<br>
                        5、签注所需时间10个工作日<br>
                        6、小孩签注必须有监护人陪同，并出具亲属关系证明（小孩不能单独办理签注）<br>
                        <br>
                        <table class=a9 cellspacing=1 cellpadding=0 width="80%" 
                  bgcolor=#000000 border=0>
                          <tbody> 
                          <tr align=middle bgcolor=#d54a25> 
                            <td width="48%"><font 
color=#ffffff><b>服务项目</b></font></td>
                            <td width="52%"><font 
                    color=#ffffff><b>所需费用</b></font></td>
                          </tr>
                          <tr align=middle bgcolor=#ffffff> 
                            <td width="48%"> 
                              <p>1年多次往返商务签证加注</p>
                            </td>
                            <td width="52%">1800RMB</td>
                          </tr>
                          <tr align=middle bgcolor=#ffffff> 
                            <td width="48%">2年多次往返商务签证加注</td>
                            <td 
                  width="52%">2600RMB</td>
                          </tr>
                          </tbody> 
          ...
          <td width=171> 
            ...
            bgcolor=#000000 border=0>
                  ...
                  height=11 src="images/companysbt.gif" width=11 
                  align=absMiddle><b> <a 
                  href="cvisa4.asp"><font color="#FF0000">台胞证签注加注服务</font></a></b></td>
                    </tr>
                    <tr> 
                      <td valign=center align=middle bgcolor=#ffffff height=22><img 
                  height=11 src="images/companysbt.gif" width=11 
