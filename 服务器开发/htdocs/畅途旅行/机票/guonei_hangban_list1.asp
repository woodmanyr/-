...
if address="请选择航班到达地点" then
sql_search="select * from holiday where address like '%'" 
else
sql_search="select * from holiday where address like '%"&address&"%'"
end if
...
rs_search.Open sql_search,conn,3,2
%><form method="POST"   name="regfrom" action="guonei_hangban_list.asp">
                    ...
                    <tr> 
                      ...
                      <td width="20%"> 
                        <select size="1" name="company">
                          <option value="所有航空公司">所有航空公司</option>
                          <%
          ...
          <tr> 
            <td width="74%" height="11"> 
              <table border="1" cellpadding="0" cellspacing="0" width="100%"  bordercolorlight="#B3C6D9" bordercolordark="#FFFFFF">
                <tr> 
                  <td width="11%" height="34" align="center" bgcolor="#7B9EC6"><font color="#FFFFFF">目的地</font></td>
                  <td width="12%" height="34" align="center" bgcolor="#7B9EC6"><font color="#FFFFFF">机场</font></td>
                  <td width="12%" height="34" align="center" bgcolor="#7B9EC6"><font color="#FFFFFF">航空公司</font></td>
                  <td width="8%" height="34" align="center" bgcolor="#7B9EC6"><font color="#FFFFFF">出发时间</font></td>
                  <td width="8%" height="34" align="center" bgcolor="#7B9EC6"><font color="#FFFFFF">到达时间</font></td>
                  <td width="7%" height="34" align="center" bgcolor="#7B9EC6"><font color="#FFFFFF">航班号</font></td>
                  <td width="5%" height="34" align="center" bgcolor="#7B9EC6"><font color="#FFFFFF">机型</font></td>
                  <td width="8%" height="34" align="center" bgcolor="#7B9EC6"><font color="#FFFFFF">每周航班</font></td>
                  <td width="9%" height="34" align="center" bgcolor="#7B9EC6"><font color="#FFFFFF">全价</font></td>
                  <td width="9%" height="34" align="center" bgcolor="#7B9EC6"><font color="#FFFFFF">特价</font></td>
                  <td width="11%" height="34" align="center" bgcolor="#7B9EC6"><font color="#FFFFFF">在线订票</font></td>
                </tr>
                <%
...
for ipage=1 to rs_search.pagesize  
                ...
                <tr onMouseMove="roll(this,'in','#D9F2FF');" 
                  ...
                  <td width="11%" height="25" align="center"><a href="#" onClick=javascript:window.open('guonei_buy.asp?id=<%=rs_search("id")%>','','500,400,scrollbars=yes,resizable=yes')><font color="#000000"> 
                ...
                <tr> 
                  <td height="18" align="center" colspan="11"> 
                    <p align="center"><font color="#333333"><b>共 <font color="#990000"><%=rs_search.pagecount%></font> 
                      页 </b>&nbsp;<a href="guonei_hangban_list.asp?company=<%=company%>&address=<%=address%>&godatemonth=<%=godatemonth%>&godateday=<%=godateday%>&page=1" class="样式1"><font color="#484848">9</font></a> 
                      <a href="guonei_hangban_list.asp?company=<%=company%>&address=<%=address%>&godatemonth=<%=godatemonth%>&godateday=<%=godateday%>&page=<%=page-1%>"> 
      ...
      response.write "<A HREF=guonei_hangban_list.asp?company="&company&"&address="&address&"&godatemonth="&godatemonth&"&godateday="&godateday&"&page="&i&">"&"<font color=#000000>"&i&"</font>"&"</A>&nbsp;"
      end if
      next
      
     
      %>
                      ]<a href="guonei_hangban_list.asp?company=<%=company%>&address=<%=address%>&godatemonth=<%=godatemonth%>&godateday=<%=godateday%>&page=<%=page+1%>" class="样式1"><font color="#484848">8</font></a> 
                      <a href="guonei_hangban_list.asp?company=<%=company%>&address=<%=address%>&godatemonth=<%=godatemonth%>&godateday=<%=godateday%>&page=<%=rs_search.PageCount%>" class="样式1"> 
...
function guonei_check()
{
  ...
  return true;
      ...
      <%
set rs=server.CreateObject("adodb.recordset")
sql="select * from address address order by address asc"
rs.Open sql,conn,3,2
%>
        ...
        <tr> 
          <td> 
            <table border="1" cellpadding="2" cellspacing="0" width="100%" bordercolorlight="#000000" bordercolordark="#FFFFFF">
              <%
        sql="select id,address from address order by id asc"
         rs.Open sql,conn,3,2
        for m=1 to rs.recordcount/10%>
              <tr> 
                <%for n=1 to 10%>
                <td width="10%" bgcolor="#FFFFFF"><a href="guonei_hangban_list.asp?address=<%=rs("address")%>"><%=rs("address")%></a></td>
                <%
                rs.movenext
                next
                %>
