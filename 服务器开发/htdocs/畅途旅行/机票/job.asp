      ...
      <table cellspacing=0 cellpadding=0 width=100% align=center border=0>
        ...
        <tr> 
          <td valign=top> <a name=1></a> 
            ...
            class=content03><strong class="mainzi">诚 聘</strong></span><span class="mainzi"> 
                    </span></div>
                </td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td> 
                  <table cellspacing=1 cellpadding=3 bgcolor=#efefef width="96%" align="center">
                    <tbody> 
                    <tr> 
                      <td bgcolor=#efefef class="mainzi">有意者请将个人简历寄至本公司</td>
                    </tr>
                    <tr> 
                      <td bgcolor=#ffffff height=2>&nbsp;</td>
                    </tr>
                    <tr> 
                      <td bgcolor=#ffffff height=2><span class="mainzi">
                        <%set rs=server.CreateObject("adodb.recordset")
%>
                        <%
id=Request.QueryString("id")
strSel="select * from qita where id=168"
