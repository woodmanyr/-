...
<BODY bgColor=#ffffff background="../images/bg.jpg" leftMargin=0 topMargin=0 onLoad="MM_preloadImages('../images/wz1_2.gif','./images/wz2_2.gif','./images/wz3_2.gif')">
<CENTER>
      ...
      <td width="576" valign="top" bgcolor="#FFFFFF"><TABLE width="100%" height="28" border=0 align=center cellPadding=0 cellSpacing=0>
          <TBODY>
            ...
            height=13 border="0" align=absMiddle> <a href="../index.asp">首 页</a> 
                ...
                <a href="./index.asp"><font color="#FF0000">会员专区</font></a> </TD>
            </TR>
          </TBODY>
...
brs.open "SELECT team_name from team where team_id="&rs("ball_test"),conn,1,1 %>
	   ...
	   set rs=nothing%>
        ...
        <p>&nbsp;</p></td>
      <td width="199" valign="top" bgcolor="#FFFFFF"><!--#include file="./right.asp"--></td>
    </tr>
  </table>
<!--#include file="../end.asp"--></CENTER></BODY>