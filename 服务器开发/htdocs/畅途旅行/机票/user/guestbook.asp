...
<TABLE WIDTH=750 BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
  <TR> 
    <TD><!--#include file="inc/top.asp"--></TD>
</TR> </TABLE> 
<%if user_vip=true then%>
<table width="750" align="center" cellpadding="0" cellspacing="1">
  <tr>
            ...
            <TR>
              <td>
                ...
                <TABLE  width=100% align=center cellPadding=0 cellSpacing=1 bgcolor="#EAEAEA" class="fontcolor">
                  <TBODY>
                    <TR>
                      <TD width="97" rowspan="2" vAlign=center bgcolor="#FAFAFA"><div align="center"><img border="0" src="images/face/<%=rs("face")%>.gif" vspace="5"><br><%=rs("name")%></div></TD>
                      <TD height="20" vAlign=center bgcolor="#FAFAFA"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="64%">留言日期：<%=rs("pubdate")%></td>
                            <td width="36%">&nbsp;</td>
                          </tr>
                      </table></TD>
                    </TR>
                    <TR>
                      <TD height="62" vAlign=middle bgcolor="#FFFFFF"><div align="left"><span ><font color="#FFCC33" >【
                                <%
						 if rs("class")=0 then Response.Write("留言")
						 if rs("class")=1 then Response.Write("建议")
						 if rs("class")=2 then Response.Write("其它")
						%>
                          】<img border="0" src="images/icon/<%=rs("icon")%>.gif">&nbsp;</font></span><%=rs("content")%><br><br>
                          <span><font color="#3333FF">【管理员回复】</font>：</span><%=rs("replay")%> </div></TD>
                    </TR>
                    <TR>
                      <TD height=25 align=middle bgcolor="#FAFAFA"><div align="center"></div></TD>
                      <TD height=25 align=middle bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="19%"><div align="left">回复日期：<%=rs("replaydate")%> </div></td>
                            <td width="81%"><div align="right">
                                <%if Request.Cookies("admin_login")="true" then%>
                                联系电话:<%=rs("web")%>&nbsp;&nbsp;E_Mail:<%=rs("email")%>
                                <%end if%>
                                <a href="?action=del&id=<%=rs("id")%>"><img src="images/mofei_del.gif" width="52" height="16" border="0"></a><a href="?action=replay_news&id=<%=rs("id")%>"><img src="images/mofei_re.gif" width="45" height="18" border="0"></a></div></td>
                          </tr>
                      </table></TD>
                    </TR>
                </TABLE>
...
<%else
		response.write"<center><p><br>对不起.你不是本站VIP会员.请注册登陆后才能查看资料</center>"
		end if%><table width="750"  border="0" align="center" cellpadding="0" cellspacing="0"> 
<tr>
    <td><div align="center">
