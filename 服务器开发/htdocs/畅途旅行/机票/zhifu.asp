        ...
        <tr> 
          <td valign=top> <a name=1></a> 
            <table cellspacing=0 cellpadding=0 width="100%" border=0>
              <tbody> 
              <tr> 
                <td width="100%" bgcolor=#efefef height=25> 
                  <div align=center><span 
            class=content03><strong class="mainzi">订票指南</strong></span></div>
                </td>
              </tr>
              <tr> 
              ...
              <tr> 
                <td> 
                  <table cellspacing=1 cellpadding=3 bgcolor=#efefef width="100%">
                    <tbody> 
                    <tr> 
                      <td bgcolor=#efefef class="mainzi">本 公 司 为 远 郊 及 外 地 客 户 
                        提 供 机 票 邮 寄 服 务,第 一 天 汇 款,第 二 天 取 票 ! </td>
                    </tr>
                    <tr> 
                      <td bgcolor=#ffffff height=2>&nbsp;</td>
                    </tr>
                    <tr> 
                      <td width="100%" bgcolor=#efefef class="mainzi">上海东航南航上航联合售票处 </td>
                    </tr>
                    <tr> 
                      <td bgcolor=#ffffff height=2>&nbsp;</td>
                    </tr>
                    <tr> 
                      <td valign=top width="100%">咨询电话：<span style="FONT-SIZE: 9pt">86-21-29949106 27871487 29949106 
                          联系人：钟小姐</span></td>
                    </tr>
                    <tr> 
                      <td width="100%"></td>
