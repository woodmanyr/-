...
%>
                <tr> 
                  <td width="81%"><a href=changshi_show.asp?id=<%=rs("id")%> target="_blank"> 
                    <font style="font-size:9pt"><%=rs("title")%></font></a></td>
                  <td width="19%"> 
                    <p align="left"><font size="2">&nbsp;&nbsp;&nbsp;<%=rs("date")%></font> 
                  </td>
                </tr>
                <%
rs.movenext
...
%>
                <tr> 
                  <td colspan="2"> 
                    <p align="center"><font color="#333333" size="2"><b>共 <font color="#990000"><%=rs.pagecount%></font> 
                      页 </b>&nbsp;<font face="webdings"><a href="server_index.asp?page=1"><font color="#484848">9</font></a></font> 
                      <font face="webdings"> <a href="server_index.asp?page=<%=page-1%>"> 
      ...
      response.write "<A HREF=server_index.asp?page="&i&">"&"<font color=#000000>"&i&"</font>"&"</A>&nbsp;"
      end if
     next
      
     
      %>
                      ]<font face="webdings"><a href="server_index.asp?page=<%=page+1%>"><font color="#484848">8</font></a></font> 
                      <font face="webdings"> <a href="server_index.asp?page=<%=rs.PageCount%>"> 
