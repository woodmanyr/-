      ...
      <td height="150" align="center" valign="middle">
        <table width="95%" border="0" cellpadding="3" cellspacing="1" bgcolor="#000000">
          ...
          <tr valign="middle" bgcolor="#C9E393"> 
            ...
            <td height="26" colspan="3"> 
              <input name="user_dz3" type="text" id="user_dz3" value="<%=user(27)%>" size="90">
            </td>
          </tr>
          <tr bgcolor="#C9E393"> 
  ...
  do while not rs1.eof                        
        ...
        loop%>
          ...
          <tr valign="middle" bgcolor="#C9E393"> 
            <td height="26">真实姓名:</td>
            <td height="26" colspan="3"> 
              <input name="user_xma" type="text" id="user_xma" value="<%=user(28)%>">
            </td>
          </tr>
          <tr valign="middle" bgcolor="#C9E393"> 
            <td height="26">联系电话:</td>
            <td height="26" colspan="3"> 
              <input name="user_urla" type="text" id="user_urla" value="<%=user(29)%>">
            </td>
          </tr>
          <tr valign="middle" bgcolor="#C9E393"> 
            <td height="26">联系手机:</td>
            <td height="26" colspan="3"> 
              <input name="user_url2a" type="text" id="user_url2a" value="<%=user(30)%>">
            </td>
          </tr>
          <tr valign="middle" bgcolor="#C9E393"> 
            <td height="26">OICQ:</td>
            <td height="26" colspan="3"> 
              <input name="user_oicqa" type="text" id="user_oicqa" value="<%=user(31)%>">
              必须为数字 </td>
          </tr>
          <tr valign="middle" bgcolor="#C9E393"> 
            <td height="26">MSN:</td>
            <td height="26" colspan="3"> 
              <input name="user_msna" type="text" id="user_msna" value="<%=user(32)%>">
            </td>
          </tr>
          <tr valign="middle" bgcolor="#C9E393"> 
            <td height="26">联系地址:</td>
            <td height="26" colspan="3"> 
              <input name="user_dza" type="text" id="user_dza" value="<%=user(33)%>" size="35">
            </td>
          </tr>
          <tr valign="middle" bgcolor="#C9E393"> 
            <td height="26">送票地址:</td>
            <td height="26" colspan="3"> 
              <input name="user_dz2a" type="text" id="user_dz2a" value="<%=user(34)%>" size="35">
            </td>
          </tr>
          <tr valign="middle" bgcolor="#C9E393"> 
            <td height="26">省份:</td>
            <td height="26" colspan="3"> 
              <input name="user_sfa" type="text" id="user_sfa" value="<%=user(35)%>">
            </td>
          </tr>
          <tr valign="middle" bgcolor="#C9E393"> 
            <td height="26">邮编:</td>
            <td height="26" colspan="3"> 
              <input name="user_yba" type="text" id="user_yba" value="<%=user(36)%>">
              必须为数字</td>
          </tr>
          <tr valign="middle" bgcolor="#C9E393"> 
            <td height="26">备注信息</td>
            <td height="26" colspan="3"> 
              <input type="text" name="user_dz3a" id="user_dz3a" value="<%=user(37)%>" size="90">
            </td>
          </tr>
          <tr bgcolor="#C9E393"> 
            <td height="26">&nbsp;</td>
