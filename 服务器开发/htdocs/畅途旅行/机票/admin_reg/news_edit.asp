...
<form name="myform" method="post" action="news_save.asp">
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#000000">
  <tr> 
      <td height="26" align="center" valign="middle" bgcolor="#008306"><strong>文章修改</strong> 
    ...
    <td height="290"> 
        <table width="100%" height="100%" border="0" align="center" cellpadding="3" cellspacing="1">
          <tr align="center" valign="middle"> 
            <td width="13%" height="26" bgcolor="#C9E393">文章类别:</td>
            <td width="87%" height="26" align="left" bgcolor="#C9E393"> <select name="nclass_id" id="nclass_id">
                <OPTION selected value="<%=news(1)%>">
				<%set rs5=server.createobject("adodb.recordset")
rs5.open "select nclass_name from nclass where nclass_id="&news(1)&"",conn,1,1%><%=rs5("nclass_name")%></OPTION>
                <%  dim rs1
...
rs1.open "select * from nclass",conn,1,3
  do while not rs1.eof                        
        ...
        %>
          ...
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393">文章标题:</td>
            <td height="26" align="left" bgcolor="#C9E393"><input name="news_title" type="text" id="news_title" value="<%=news(2)%>" size="50"> 
              <font color="#FF0000"> *</font></td>
          </tr>
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393">文章连接:</td>
            <td height="26" align="left" bgcolor="#C9E393"><input name="news_link" type="text" id="news_link" value="<%=news(4)%>" size="50">
            </td>
          </tr>
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393">图片地址:</td>
            <td height="26" align="left" bgcolor="#C9E393"><input name="news_images" type="text" id="news_images" value="<%=news(9)%>" size="50"></td>
          </tr>
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393">UBB标签:</td>
            <td height="26" align="left" bgcolor="#C9E393"> <img onClick=bold() src="<%=config(5)%>icon_editor_bold.gif" width="22" height="22" alt="粗体" border="0"> 
              <img onClick=italicize() src="<%=config(5)%>icon_editor_italicize.gif" width="23" height="22" alt="斜体" border="0"> 
              <img onClick=underline() src="<%=config(5)%>icon_editor_underline.gif" width="23" height="22" alt="下划线" border="0"> 
              <img onClick=center() src="<%=config(5)%>icon_editor_center.gif" width="22" height="22" alt="居中" border="0"> 
              <img onClick=hyperlink() src="<%=config(5)%>icon_editor_url.gif" width="22" height="22" alt="超级连接" border="0"> 
              <img onClick=email() src="<%=config(5)%>icon_editor_email.gif" width="23" height="22" alt="Email连接" border="0"> 
              <img onClick=image() src="<%=config(5)%>icon_editor_image.gif" width="23" height="22" alt="图片" border="0"> 
              <img onClick=flash() src="<%=config(5)%>swf.gif" width="23" height="22" alt="Flash图片" border="0"> 
              <img onClick=showcode() src="<%=config(5)%>icon_editor_code.gif" width="22" height="22" alt="编号" border="0"> 
              <img onClick=quote() src="<%=config(5)%>icon_editor_quote.gif" width="23" height="22" alt="引用" border="0"> 
              <img onClick=list() src="<%=config(5)%>icon_editor_list.gif" width="23" height="22" alt="目录" border="0"> 
              <img onClick=setfly() height=22 alt=飞行字 src="<%=config(5)%>fly.gif" width=23 border=0> 
              <img onClick=move() height=22 alt=移动字 src="<%=config(5)%>move.gif" width=23 border=0> 
              <img onClick=glow() height=22 alt=发光字 src="<%=config(5)%>glow.gif" width=23 border=0> 
              <img onClick=shadow() height=22 alt=阴影字 src="<%=config(5)%>shadow.gif" width=23 border=0><br>
              字体： 
              ...
              HTML代码标签:『<a href="javascript:openscriphtml()"><font color=#990000>LFBBS 
              HTML 编辑器</font></a>』 </td>
          </tr>
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393">文章内容: </td>
            <td height="26" align="left" bgcolor="#C9E393"><textarea name="news_type" cols="56" rows="12" id="news_type"><%
	content=replace(news(3),"<BR>",chr(13))
...
%></textarea>
          ...
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393"> 文章作者:</td>
            <td height="26" align="left" bgcolor="#C9E393"> <input name="news_writer" type="text" id="news_writer" value="<%=news(6)%>" size="15"> 
              <font color="#FF0000">*</font></td>
          </tr>
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393">文章来源:</td>
            <td height="26" align="left" bgcolor="#C9E393"><input name="news_from" type="text" id="news_from" value="<%=news(5)%>" size="30"></td>
          </tr>
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393">是否HTML:</td>
            <td height="26" align="left" bgcolor="#C9E393"> <input type="checkbox" name="html" value="checkbox"> 
              <font color="#FF0000">选择后文章全部支持HTML语法，UBB语法将没有任何作用</font> </td>
          </tr>
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393">是否VIP:</td>
            <td height="26" align="left" bgcolor="#C9E393"><input <%If news(10) = true Then Response.Write("checked") : Response.Write("")%> name="news_vip" type="checkbox">
              选择后.只有VIP会员才能浏览 </td>
          </tr>
          <tr align="center" valign="middle"> 
...
<div align="center">
      <input name="news_id" type="hidden" id="news_id" value="<%=news(0)%>"> 
          <input name="news_add_add" type="hidden" id="news_add_add" value="edit">
