...
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#000000">
  <tr> 
      <td height="26" align="center" valign="middle" bgcolor="#008306"><strong><font color="#FFFFFF">文章添加</font></strong> 
    ...
    <td height="290"> 
        <table width="100%" height="100%" border="0" align="center" cellpadding="3" cellspacing="1">
          <tr align="center" valign="middle"> 
            <td width="13%" height="26" bgcolor="#C9E393">新闻类别:</td>
  ...
  do while not rs1.eof                        
        ...
        %>
          ...
          <tr align="center" valign="middle"> 
            ...
            <td height="26" align="left" bgcolor="#C9E393"><input name="news_title" type="text" id="news_title" size="50"> 
              <font color="#FF0000"> *</font></td>
          </tr>
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393">文章连接:</td>
            <td height="26" align="left" bgcolor="#C9E393"><input name="news_link" type="text" id="news_link" size="50">
            </td>
          </tr>
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393">图片地址:</td>
            <td height="26" align="left" bgcolor="#C9E393"><input name="news_images" type="text" id="news_images" size="50"></td>
          </tr>
          <tr align="center" valign="middle"> 
          ...
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393">新闻内容: </td>
            <td height="26" align="left" bgcolor="#C9E393"><textarea name="news_type" cols="56" rows="12" id="news_type"></textarea>
              <font color="#FF0000">*</font> </td>
          </tr>
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393"> 新闻作者:</td>
            <td height="26" align="left" bgcolor="#C9E393"> <input name="news_writer" type="text" id="news_writer" size="15"> 
              <font color="#FF0000">*</font></td>
          </tr>
          <tr align="center" valign="middle"> 
            <td height="26" bgcolor="#C9E393">新闻来源:</td>
            <td height="26" align="left" bgcolor="#C9E393"><input name="news_from" type="text" id="news_from" size="30"></td>
          </tr>
          <tr align="center" valign="middle">
          ...
          <tr align="center" valign="middle"> 
            ...
            <td height="26" align="left" bgcolor="#C9E393"><input name="news_vip" type="checkbox" id="news_vip" value="checkbox">
              选择后.只有VIP会员才能浏览 </td>
          </tr>
          <tr align="center" valign="middle"> 
...
<div align="center"> 
<input type="hidden" name="news_add" value="<%=user(2)%>">
        <input type="hidden" name="news_add_add" value="save">
